...
<html lang="en">
  ...
  <body>
	...
	<!-- Slick slider -->
    <script type="text/javascript" src="{{ asset('assets/app-js/slick.min.js') }}"></script>
    <!-- Counter js -->
    <script type="text/javascript" src="{{ asset('assets/app-js/counter.js') }}"></script>
    <!-- Ajax contact form  -->
    <script type="text/javascript" src="{{ asset('assets/app-js/app.js') }}"></script>
   
    <!-- Custom js -->
	<script type="text/javascript" src="{{ asset('assets/app-js/custom.js') }}"></script>
